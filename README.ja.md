...
<p align="center">
  <img src="docs/images/monitor.png" alt="Monitor画面 1" width="240">
  <img src="docs/images/monitor2.png" alt="Monitor画面 2" width="240">
  <img src="docs/images/monitor3.png" alt="Monitor画面 3" width="240">
</p>
...
| アイコン | 機能 |
|------|----------|
| **Select**（ドロップダウン） | 表示するフロアマップを選択・切り替えます。現在選択中のサイト・フロアが上に表示されます（例: "Home - Home6F"）。 |
| **ドット9個のアイコン** | フロアマップ・AP位置情報を取得します。 |
| **ルーター型のアイコン** | AP位置情報を取得します。 |
| **チェーン/リンクのアイコン** | 接続線の表示/非表示を切り替えます（各スナップショットと、その時点で接続していたAPを結ぶ線）。 |
| **Sync** | 現在のサイト/フロアのAP情報やマップデータを最新の状態に同期します。 |
| **ダウンロード**（下向き矢印） | サーベイデータをエクスポートします。フロアマップ・AP位置・全スナップショットをZIPにまとめ、Webアナライザーで分析できる形式で保存します。 |

> 注: ドット9個とルーター型アイコンの機能は画面上の見た目だけでは厳密に区別できないため、上記の説明は推測ベースです。

<!-- SCREENSHOT: Map画面 — スナップショット配置済みフロアマップのスクショをここに配置 -->
<p align="center">
  <img src="docs/images/map.png" alt="Map画面 1" width="300">
  <img src="docs/images/map2.png" alt="Map画面 2" width="300">
</p>
...
<p align="center">
  <img src="docs/images/settings.png" alt="Settings画面 1" width="240">
  <img src="docs/images/settings2.png" alt="Settings画面 2" width="240">
  <img src="docs/images/settings3.png" alt="Settings画面 3" width="240">
</p>
